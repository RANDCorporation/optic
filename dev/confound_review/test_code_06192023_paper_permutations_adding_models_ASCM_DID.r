...
# Max edit: Recode state to a numeric to get CSA model to work:
...
#fixedeff_linear, lm_ar, multisynth_model, 

linear_fe_config <- optic_simulation(
  x=data,
  models=list(did_model),
  iters=5,
  method = "confounding",
...
setwd("C:/Users/bethg/Documents/OPTIC/Simulation Project/Selection Bias Sims/Updated runs")
