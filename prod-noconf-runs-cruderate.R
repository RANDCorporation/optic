...
linear25 <- 3450 / ((sum(x$population) / length(unique(x$year))) / 100000)
...
write.csv(linear_fe_results, "/poppy/programs/josephp/output/noconf-cruderate-linear-fe-weighted-05-20-21.csv", row.names = FALSE)
...
write.csv(linear_ar_results, "/poppy/programs/josephp/output/noconf-cruderate-linear-ar-weighted-05-20-21.csv", row.names = FALSE)
proc.time2 = proc.time()
print(proc.time2-proc.time1)
...
write.csv(multisynth_results, "/poppy/programs/josephp/output/noconf-cruderate-linear-multisynth-weighted-05-20-21.csv", row.names = FALSE)
