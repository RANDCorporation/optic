...
df_sim[, sim_variance_50 := quantile(.SD$sim_variance, 0.5), by = sum_cols]
df_sim[, sim_variance_025 := quantile(.SD$sim_variance, 0.025), by = sum_cols]
df_sim[, sim_variance_975 := quantile(.SD$sim_variance, 0.975), by = sum_cols]
