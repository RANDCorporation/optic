# Figure1.R ---------------------------------------------------------------
# 
# Run the new Figure 1 for the revision of the concurrent simulation paper.
# 
...
fig_base <- (autoreg_relbias + plot_spacer()) / plot_spacer() + 
...
ggsave(glue('{outputPath}/new_figures/Figure1.png'), width=10, height=9)
