...
*PNL Note: Max to edit this file. Max, you should write R code as below, as opposed to pure markdown that does not run the R code.*

This vignette purpose is to teach you how to use the `optic` package by running the following simulation scenarios:
