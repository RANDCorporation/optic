...
bias_vals <- list(
  ...
  multisynth = list(
    linear = list(
      mva3 = list(
        small=c(b0=-5, b1=0.007, b2=0.01, b3=0, b4=0, b5=0,
                a1=0.01, a2=0.01, a3=0, a4=0, a5=0),
        medium=c(b0=-5, b1=0.01, b2=0.01, b3=0, b4=0, b5=0,
                 a1=0.05, a2=0.01, a3=0, a4=0, a5=0),
        large=c(b0=-5, b1=0.01, b2=0.04, b3=0, b4=0, b5=0,
      ...
      trend = list(
        ...
        medium=c(b0=-5, b1=0.02, b2=0.1, b3=0, b4=0, b5=0,
                 a1=0.15, a2=0.46, a3=0, a4=0, a5=0),
        large=c(b0=-5, b1=0.05, b2=0.1, b3=0, b4=0, b5=0,
                a1=0.15, a2=0.8, a3=0, a4=0, a5=0),
        none = c(b0=0, b1=0, b2=0, b3=0, b4=0, b5=0,
                 a1=0, a2=0, a3=0, a4=0, a5=0))
    ),
    nonlinear = list(
