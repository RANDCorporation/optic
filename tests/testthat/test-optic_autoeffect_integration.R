...
test_that("autoeffect integration runs alongside TWFE model", {
  ...
  expect_true("twfe" %in% comparison$model_name)
  expect_true("autoeffect_debiased" %in% comparison$model_name)
})
