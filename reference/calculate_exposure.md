...
- monthly_effect:
  ...
  increment of exposure to apply each month; default is ((1/n_years)
  / 12) (constant over the period)

## Value

A vector of percentages, indicating change in exposure by year (relative
to start month)
